 ...
 * @author arrenbryan
 */
public class MenuLoginNomor extends javax.swing.JFrame implements IATMPad, IConfig {

    private Account account = new Account();

    public MenuLoginNomor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        LblMemasukkanNomor = new javax.swing.JLabel();
        ...
        LblMasukkanNomor.setText("MASUKKAN NOMOR REKENING (10 DIGIT)");
        ...
        LblMemasukkanNomor.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N
        LblMemasukkanNomor.setForeground(java.awt.Color.white);
        LblMemasukkanNomor.setText("MEMASUKKAN NOMOR REKENING");
        ...
        PnlUtamaATMLayout.setHorizontalGroup(
            ...
            .addGroup(PnlUtamaATMLayout.createSequentialGroup()
                ...
                .addGroup(PnlUtamaATMLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PnlUtamaATMLayout.createSequentialGroup()
                        .addGroup(PnlUtamaATMLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(LblMemasukkanNomor)
    ...
    private void BtnEnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEnterActionPerformed
        ...
        for (i = 0; i <= accountList.length - 1; i++) {
            if (account.getAccountNumber().equals(accountList[i].getAccountNumber())) {
                MenuLoginPIN mn_loginPIN = new MenuLoginPIN(account);
                mn_loginPIN.setVisible(true);
                this.dispose();
                break;
            }
        }
    ...
    private javax.swing.JLabel LblMemasukkanNomor;
    ...
    public void message(String angka) {
        if (TxtFieldNomor.getText().length() != LIMITNOMORREKENING) {
            account.appendAccountNumber(angka);
            TxtFieldNomor.setText(account.getAccountNumber());
        }
    }
